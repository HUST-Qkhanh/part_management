...
execute_process(
  COMMAND "F:/Git/cmd/git.exe" --git-dir=.git show-ref "qds-4.5"
  WORKING_DIRECTORY "F:/qt_ws/PartManagament/build/_deps/ds-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'F:/qt_ws/PartManagament/build/_deps/ds-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'F:/qt_ws/PartManagament/build/_deps/ds-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
